  ...
  return (
    <div className="relative z-20 py-10 md:py-40">
      ...
      <Subheading className="text-center max-w-lg mx-auto">
        Pets AI is used by millions of people around the globe.Our APIs have
...
const testimonials = [
  {
    name: "Manu Arora",
    quote:
      "What a fantastic AI Pets AI is, I just love it. It has completely transformed the way I approach problems and develop solutions.",
